    ...
    if (authMode === 'login') {
      ...
      if (email === 'wooohan3@gmail.com' && password === 'Zayn@1122') {
        ...
        const demoUser: User = {
          ...
          role: 'user',
          plan: 'Starter',
          dailyLimit: 100, // Limit set to 100
        ...
        // Check if this demo user already exists in DB (optional, but good for consistency)
        const existingIndex = MOCK_USERS.findIndex(u => u.email === email);
        if (existingIndex === -1) {
      ...
      // Update the mock database so Admin can see this new user
